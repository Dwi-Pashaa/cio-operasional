...
@section('title', 'Reset Password - CIO Operasional')
...
@section('content')
    <div class="text-center mb-4">
        ...
        <h2 class="card-title fw-bold">Buat Password Baru - CIO Operasional</h2>
        <p class="card-subtitle text-muted">
            Silakan masukkan password baru untuk akun <strong>{{ $email }}</strong> di CIO Operasional
        </p>
    </div>
