...
@section('title', 'Lupa Password - CIO Operasional')
...
@section('content')
    <div class="text-center mb-4">
        ...
        <h2 class="card-title fw-bold">Lupa Password - CIO Operasional</h2>
        <p class="card-subtitle text-muted">
            Masukkan Username atau Email Anda. Kami akan mengirimkan kode verifikasi OTP ke kontak terdaftar Anda untuk mengatur ulang password CIO Operasional.
        </p>
    </div>
