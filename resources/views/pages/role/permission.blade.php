...
@php
    ...
    $groupedPermissions = [
        ...
        'Master Role & Hak Akses' => [
            ...
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'role'))
        ],
        ...
        'Master Katalog Barang' => [
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon text-primary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5" /><path d="M12 12l8 -4.5" /><path d="M12 12l0 9" /><path d="M12 12l-8 -4.5" /></svg>',
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'barang'))
        ],
        'Pengeluaran Operasional' => [
            ...
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'pengeluaran'))
        ],
        'Laporan & Unduhan' => [
            ...
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'laporan') || str_contains(strtolower($p->name), 'excel') || str_contains(strtolower($p->name), 'pdf'))
        ],
        'Pengaturan Sistem' => [
            'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon text-primary"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z" /><path d="M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0" /></svg>',
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'pengaturan'))
        ],
    ];
                                    ...
                                    <div class="row g-2">
                                        @foreach ($moduleData['items'] as $item)
                                            @php
                                                ...
                                                } elseif (str_contains($pName, 'buat')) {
